...
function MetricRow({ label, value, highlight, isCount }: {
  ...
  const color = highlight === 'positive' ? 'text-green-600' : highlight === 'negative' ? 'text-red-600' : 'text-slate-900 dark:text-slate-100'
  return (
    ...
    <div className="flex flex-col gap-6">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <Card>
            <h3 className="mb-2 font-display font-semibold text-slate-900 dark:text-slate-100">Resultado do Período</h3>
          ...
          <Card>
            <h3 className="mb-2 font-display font-semibold text-slate-900 dark:text-slate-100">Folha e Equipe</h3>
          ...
          <Card>
            <h3 className="mb-2 font-display font-semibold text-slate-900 dark:text-slate-100">Contas a Pagar e Receber</h3>
          ...
          <Card>
            <h3 className="mb-2 font-display font-semibold text-slate-900 dark:text-slate-100">Tributos</h3>
